...
<body>
    ...
    $(function () {
        ...
        <li><span><img src="<%=basePath %>images/t03.png" /></span>删除
        &nbsp;&nbsp;&nbsp;&nbsp;<input  type="text" name="starttime" class="dfinput" readonly="true" value="" />
        </li>
        </ul>
    </div>
    ...
    <c:forEach items="${roleList}" var="role">
      	<tr>
	    	...
	    	<td><a href="#">${role.roleName}</a><p>ID: ${role.roleId}</p></td>
	   		<td>${role.roleDec}</td>
	    	<td><a href="#">角色授权</a></td>
	    </tr>
    </c:forEach>
